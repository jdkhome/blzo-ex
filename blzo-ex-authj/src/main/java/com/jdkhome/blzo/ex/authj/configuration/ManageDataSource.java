package com.jdkhome.blzo.ex.authj.configuration;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.jdkhome.blzo.ex.authj.generator.dao"}, sqlSessionFactoryRef = "ManageSqlSessionFactory")
...
public class ManageDataSource {
    ...
    public SqlSessionFactory ManagerSqlSessionFactory(@Autowired @Qualifier("ManageDataSource") DataSource ManageDataSource) throws Exception {
        ...
        fb.setTypeAliasesPackage("com.jdkhome.blzo.ex.authj.generator.model");
